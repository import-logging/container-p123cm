...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-p123cm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-p123cm.containers.anotherwebservice.com/
...
```
git clone git@github.com:import-logging/container-p123cm.git
cd container-p123cm
```
...
```
docker attach container-p123cm
```
